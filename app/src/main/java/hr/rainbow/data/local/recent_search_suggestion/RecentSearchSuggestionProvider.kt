...
private const val AUTHORITIES = "hr.rainbow.recent.search.suggestion"
private const val PATH = "items"
private const val ITEMS = 10
private const val ITEM_ID = 20
val RECENT_SEARCH_SUGGESTION_PROVIDER_URI: Uri = Uri.parse("content://$AUTHORITIES/$PATH")
...
class RecentSearchSuggestionProvider : ContentProvider() {

    private lateinit var db: IRecentSearchDb

    override fun onCreate(): Boolean {
        db = RecentSearchSqlLite(context)
        return true
    }
